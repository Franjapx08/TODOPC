var App = new Vue({
  ...
  created() {
    axios
      .post(this.servicesConfig + "getEnlaceControl.php", {
        responseType: "json"
      })
      .then(r => {
  ...
  methods: {
    ...
    modificarProceso() {
      ...
      axios
        .post(this.servicesConfig + "updateEnlace.php", dataSends)
        .then(r => {
          if (r.data.code == 1) {
            location.reload();
          } else {
    ...
    updateEstatus() {
      ...
      axios
        .post(this.servicesConfig + "updateEnlaceEstatus.php", dataSends)
        .then(r => {
          if (r.data.code == 1) {
            location.reload();
          } else {
    ...
    eliminar() {
      ...
      dataSends.append("id", this.idSelect);
      axios
        .post(this.servicesConfig + "deleteEnlace.php", dataSends)
        .then(r => {
          if (r.data.code == 1) {
            location.reload();
          } else {
    ...
    nuevoAnuncio() {
      ...
      if (this.form.titulo != null) {
        ...
        dataSends.append("titulo", this.form.titulo);
        axios
          .post(this.servicesConfig + "insertEnlace.php", dataSends)
          .then(r => {
            if (r.data.code == 1) {
              location.reload();
            } else {
