var App = new Vue({
  ...
  created() {
    axios
      .post(this.servicesConfig + "getGaleriaControl.php", {
        responseType: "json"
      })
      .then(r => {
  ...
  methods: {
    ...
    modificar() {
      ...
      axios
        .post(this.servicesConfig + "updateGaleriaEstatus.php", dataSends)
        .then(r => {
          if (r.data.code == 1) {
            location.reload();
          } else {
    ...
    confirmElim() {
      ...
      axios
        .post(this.servicesConfig + "deleteGaleria.php", dataSends)
        .then(r => {
          if (r.data.code == 1) {
            location.reload();
          } else {
    ...
    insertAnuncio() {
      ...
      axios
        .post(this.servicesConfig + "insertGaleria.php", dataSends)
        .then(r => {
          if (r.data.code == 1) {
            location.reload();
          } else {
