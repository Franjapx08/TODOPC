...
<body>
                ...
                <div class="row" id="datos" v-if="data">
                  <table class="table">
                    ...
                    <tbody>
                      <tr v-for="index in datos">
                        ...
                        data-toggle="modal" data-target="#exampleModalLong2" @click="modificarProcess(index.titulo, index.id)">Modifiar</button>
                        </th>
                        ...
                        <div class="modal-body">
                          <form>
                            <div class="form-group">
                                ...
                                <input type="text" v-model="form.titulo" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                  ...
                  <div class="modal fade" id="exampleModalLong3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle2" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLongTitle2">Nuevo anuncio</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
  ...
  <script src="js/admServicio.js"></script>
<?php
  }else{
